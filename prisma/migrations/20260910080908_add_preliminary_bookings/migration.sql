...
INSERT INTO "new_Settings" ("id", "maxMinutes", "minMinutes", "scheduleLayout", "stepMinutes", "updatedAt") SELECT "id", "maxMinutes", "minMinutes", "scheduleLayout", "stepMinutes", "updatedAt" FROM "Settings";
DROP TABLE "Settings";
