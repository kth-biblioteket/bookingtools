...
const sv: Dictionary = {
  ...
  admin: {
    ...
    saving: "Sparar…",
    roomsHeading: "Rum",
    roomsSubtitle: "Lägg till eller ta bort rum.",
  ...
  adminRooms: {
    ...
    heading: "Hantera rum",
    subtitle: "Lägg till nya rum eller ta bort befintliga. Att ta bort ett rum tar även bort alla dess bokningar.",
  ...
  home: {
    heading: "Välj schema",
    subtitle: "Välj vilket bokningsschema du vill se.",
    none: "Det finns inga aktiva scheman just nu.",
    manageSchedules: "Hantera scheman →",
  },
  systemAdmin: {
    heading: "Scheman",
    subtitle: "Skapa, döp om, aktivera eller avaktivera bokningsscheman.",
    addHeading: "Lägg till schema",
    existingHeading: "Befintliga scheman",
    slug: "Kortnamn (i webbadressen)",
    slugPlaceholder: "t.ex. resursrum",
    name: "Namn",
    descriptionOptional: "Beskrivning (valfritt)",
    addSubmit: "Lägg till schema",
    addSubmitPending: "Lägger till…",
    rename: "Redigera",
    save: "Spara",
    savingPending: "Sparar…",
    activate: "Aktivera",
    deactivate: "Avaktivera",
    inactive: "Inaktivt",
    created: "Schemat är tillagt!",
